...
class FlightForm(forms.Form):
    ...
    date = forms.DateField(initial=datetime.date.today,label='DATE',widget=forms.TextInput(attrs={'class' : 'fd-form form-control','placeholder':'YYYY-MM-DD'}),input_formats=['%Y-%m-%d'],required=False)
